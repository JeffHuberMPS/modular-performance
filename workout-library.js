...
window.MPSLibrary = (function () {
  ...
  var CSS = ''
    ...
    + '.mpslib-chips{display:flex;gap:7px;flex-wrap:wrap;margin-top:10px;}.mpslib-chip{font-size:12px;padding:8px 14px;border-radius:16px;background:linear-gradient(180deg,#161a20,#0b0d11);border:1px solid var(--ln);color:var(--dim);cursor:pointer;text-transform:capitalize;transition:.12s;box-shadow:0 3px 7px rgba(0,0,0,.55),inset 0 1px 0 rgba(255,255,255,.06);}.mpslib-chip:active{transform:translateY(1px);}.mpslib-chip.on{background:rgba(var(--argb),.14);border-color:var(--a);color:var(--a);}'
    ...
    + '.mpslib-glabel{display:flex;align-items:center;gap:13px;font-family:var(--disp,Oswald,sans-serif);font-size:30px;font-weight:600;letter-spacing:2.5px;text-transform:uppercase;color:var(--tx);margin:32px 2px 12px;line-height:1;}.mpslib-glabel::before{content:"";width:6px;height:30px;border-radius:3px;background:var(--a);box-shadow:0 0 16px rgba(var(--argb),.6);}'
