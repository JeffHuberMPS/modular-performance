...
window.MPSLibrary = (function () {
  ...
  var CSS = ''
    ...
    + '.mpslib-slabel{display:flex;align-items:center;gap:8px;font-size:11px;letter-spacing:1.6px;font-size:14px;text-transform:uppercase;color:var(--a);margin:26px 2px 10px;padding-bottom:8px;border-bottom:1px solid var(--ln);}.mpslib-slabel span{color:var(--faint);font-weight:600;}.mpslib-glabel + .mpslib-slabel{margin-top:2px;}.mpslib-group > .mpslib-slabel:first-child{margin-top:6px;}'
